        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inwards_Companies_ShipMentCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OutwardNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    OutwardDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BillToCompanyId = table.Column<int>(type: "int", nullable: false),
                    InvoiceNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    InvoiceDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ChallanNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Remarks = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Outwards_Companies_BillToCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleReturns_Companies_BillToCompanyId",
                        column: x => x.BillToCompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersInRoles_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InwardItems_Inwards_InwardId",
                        column: x => x.InwardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InwardBarcodeItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InwardBarcodeItems_InwardItems_InwardItemId",
                        column: x => x.InwardItemId,
                        principalTable: "InwardItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InwardBarcodeItems_Inwards_InwardId",
                        column: x => x.InwardId,
                        principalTable: "Inwards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InwardBarcodeItems_InwardId",
                table: "InwardBarcodeItems",
                column: "InwardId");

            migrationBuilder.CreateIndex(
                name: "IX_InwardBarcodeItems_InwardItemId",
                table: "InwardBarcodeItems",
                column: "InwardItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InwardItems_InwardId",
                table: "InwardItems",
                column: "InwardId");

            migrationBuilder.CreateIndex(
                name: "IX_InwardItems_ProductId",
                table: "InwardItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Inwards_ShipMentCompanyId",
                table: "Inwards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Outwards_BillToCompanyId",
                table: "Outwards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleReturns_BillToCompanyId",
                table: "SaleReturns",
                column: "BillToCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersInRoles_CompanyId",
                table: "UsersInRoles",
                column: "CompanyId");
