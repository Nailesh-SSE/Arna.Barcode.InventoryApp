...
{
    /// <inheritdoc />
    public partial class CreateInventoryReportView : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
            IF OBJECT_ID('dbo.vw_InventoryReport', 'V') IS NOT NULL
            DROP VIEW dbo.vw_InventoryReport;
             ");
        ...
        {
            migrationBuilder.Sql(@"
                DROP VIEW IF EXISTS dbo.vw_InventoryReport;
            ");
        }
    }
}
